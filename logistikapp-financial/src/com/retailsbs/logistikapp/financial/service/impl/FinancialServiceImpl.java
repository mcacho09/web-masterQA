...
public class FinancialServiceImpl implements FinancialService {
	...
	public String sendTicketByIdOrder(Long id_order) {
		...
		String ticketInfo = "<tr>" + "<td><b>Plaza:</b></td>" + "<td>"
				...
				+ "<tr>" + "<td><b>No. Transacci贸n</b>:</td>" + "<td>"
		...
		if (!productsDEV.isEmpty()) {
			body += "<h4 style=\"text-align: center;\">Devoluci贸n</h4>"
					+ "<table style=\"width: 100%; text-align: left;\">"
					+ "<thead>"
					+ "<tr>"
					+ "<th>Producto</th>"
					...
					+ totalProductsDev
					+ "</td>"
					+ "<td style=\"text-align: right;\"><b>Total Devoluci贸n:</b> $"
	...
	public String sendNotificationByIdOrder(String store, String supplier, String date, String seller, String r_email, String s_email, String telefono, String hora, String llegada) {
		...
		String ticketInfo = 
				...
				+ seller + "</td>" + "</tr>" + "<tr>"
				+ "<tr>" + "<td style=\"font-size: initial; color: darkslategrey;\"><b>Tel閒ono: </b></td>" + "<td>"
				+ telefono + "</td>" + "</tr>" + "<tr>"
		...
		if (r_email == null || r_email.isEmpty())
			return "Correo de entrega no enviado, compruebe su informaci髇.";
		else
			return "";
	}
