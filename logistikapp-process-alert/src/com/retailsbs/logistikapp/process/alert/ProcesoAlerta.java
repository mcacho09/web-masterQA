package com.retailsbs.logistikapp.process.alert;
...
public class ProcesoAlerta {
	 ...
	 * CONTEXTO
	 */
	private void contexto() throws Exception{
		logger.info("***** INICIO CONTEXTO *****");

		String[] xml = new String[2];
		xml[0] = "classpath:applicationContext.xml";
		xml[1] = "classpath:applicationContext-user.xml";

		ApplicationContext ctx = new ClassPathXmlApplicationContext(xml);
		userService = (UserService) ctx.getBean("UserServiceBean");
...
//		User us = userService.getUserById(1L);
	...
	public static void main(String[] args) {
		...
		ProcesoAlerta alert = new ProcesoAlerta();
		try {
