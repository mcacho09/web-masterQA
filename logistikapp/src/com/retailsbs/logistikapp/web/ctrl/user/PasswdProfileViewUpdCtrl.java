 ...
 * @author juan carlos
 * @since 31-03-2015
 * @modified-Sergio Valenzuela-Correccion id_suplier-24-06-2015
 */
public class PasswdProfileViewUpdCtrl extends SimpleFormController {
	...
	public PasswdProfileViewUpdCtrl() {
		setSessionForm(true);
	...
	protected Map<String, Object> referenceData(HttpServletRequest arg0, Object arg1, Errors arg2) throws Exception {
		...
		if(arg0.getParameter("id")!=null && !arg0.getParameter("id").equals("")){
			idUser = ServletRequestUtils.getLongParameter(arg0, "id");
			datos_new = userService.getUserById(idUser);
		}
		logger.debug("idUser="+idUser);
		
		list = (arg0.getParameter("list")!=null && !arg0.getParameter("list").equals("") && arg0.getParameter("list").equals("true"));
		...
		model.put("upasswd", datos_new.getPasswd());
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws ServletException, UserNotFoundException, AccessNotFoundException {
		...
		*/
		...
		/*--------------------------------------
		 * -----------------*/
		return new ModelAndView(list?"redirect:cfguserlist.htm":getSuccessView()+"?id="+useracegi.getId_user());
	}
