...
import com.retailsbs.logistikapp.web.ctrl.validator.CityValidatorAddCtrl;

public class CityViewAddCtrl extends SimpleFormController {
	...
	private CityValidatorAddCtrl validator;
	...
	public void setValidator(CityValidatorAddCtrl validator) {
	...
	protected Map<String, Object> referenceData(HttpServletRequest arg0, Object arg1, Errors arg2) throws Exception{
		...
		String titulo_estado = "Nueva ciudad";
	...
	protected Object formBackingObject(HttpServletRequest request) throws ServletException {
		...
		AddCityDTO command = new AddCityDTO();
		return command;
	}
	...
	protected ModelAndView onSubmit(HttpServletRequest request,HttpServletResponse response, Object command, BindException errors) throws ServletException {
		...
		AddCityDTO dto = (AddCityDTO) command;
		dto.setCreated(new Date());
		dto.setActive(active);

		// Se persiste el objeto
		Long id = retailService.addCity(dto);
		logger.debug("City, id=" + id + " creado... OK");
