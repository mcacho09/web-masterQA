 ...
 * @since 25-11-2014
 * @modified 14-01-2015 - JORGE - estandarizaciOn estructura de controller
 ...
 */
public class RetailViewUpdCtrl extends SimpleFormController {
	...
	protected Map<String, Object> referenceData(HttpServletRequest arg0, Object arg1, Errors arg2) throws Exception {
		...
		Long id_retail_category= retail.getId_retail_category();
		...
		dto.setId_retail_category(id_retail_category);
	...
	protected Object formBackingObject(HttpServletRequest request) throws ServletException, RetailNotFoundException{
		logger.debug("---- FORMBACKINGOBJECT ----");
		// Se obtiene objeto de dominio del retail
		Long id_retail = ServletRequestUtils.getLongParameter(request, "id");
		Retail retail  = retailService.getRetailById(id_retail);
		
		// Se setea el objeto command con los datos
		// del objeto de dominio
		UpdRetailDTO command = new UpdRetailDTO();
		command.setActive(retail.getActive());
		command.setAddress1(retail.getAddress1());
		command.setAddress2(retail.getAddress2());
		command.setCode(retail.getCode());
		command.setCreated(retail.getCreated());
		command.setId_city(retail.getId_city());
		command.setId_country(retail.getId_country());
		command.setId_locality(retail.getId_locality());
		command.setId_retail(retail.getId_retail());
		command.setId_retail_category(retail.getId_retail_category());
		command.setId_state(retail.getId_state());
		command.setId_supplier(retail.getId_supplier());
		command.setLogin(retail.getLogin());
		command.setModified(retail.getModified());
		command.setName(retail.getName());
		command.setOrderby(retail.getOrderby());
		command.setPostal(retail.getPostal());
		command.setPhone(retail.getPhone());
		command.setEmail(retail.getEmail());
		command.setObs(retail.getObs());
	...
	protected ModelAndView onSubmit(HttpServletRequest request, HttpServletResponse response, Object command, BindException errors) throws ServletException, RetailNotFoundException, AccessNotFoundException{
		...
		UpdRetailDTO dto = (UpdRetailDTO) command;
