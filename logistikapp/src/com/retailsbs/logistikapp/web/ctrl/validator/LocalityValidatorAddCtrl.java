...
public class LocalityValidatorAddCtrl implements Validator {
	...
	public boolean supports(Class locality) {
		return locality.equals(AddLocalityDTO.class);
	}

	@Override
	public void validate(Object arg0, Errors arg1) {
		AddLocalityDTO dto = (AddLocalityDTO) arg0;
		...
		if( dto == null ) {
			...
			if( orderby == null ) arg1.rejectValue("orderby", "error.code","Selecciona un orden de listado");
