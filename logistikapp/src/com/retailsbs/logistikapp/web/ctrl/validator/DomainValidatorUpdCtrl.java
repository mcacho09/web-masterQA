...
public class DomainValidatorUpdCtrl implements Validator {
	...
	public boolean supports(Class domain) {
		return domain.equals(UpdDomainDTO.class);
	}

	@Override
	public void validate(Object arg0, Errors arg1){
		UpdDomainDTO dto = (UpdDomainDTO) arg0;
		...
		if( dto == null ) {
			...
			dto_dom.setId_domain(dto.getId_domain());
