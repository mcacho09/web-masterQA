...
public class StoreValidatorUpdCtrl implements Validator {
	...
	public boolean supports(Class store) {
		return store.equals(UpdStoreDTO.class);
	}

	@Override
	public void validate(Object arg0, Errors arg1) {
		UpdStoreDTO dto = (UpdStoreDTO) arg0;

		if (dto == null) {
			arg1.reject("error.nullpointer", "Null data received");
		} else {

			Long id_store = dto.getId_store();
			...
			if ( name == "" ) arg1.rejectValue("name", "error.code", "Debes ingresar un nombre de cliente");
			...
			if ( id_city == null ) arg1.rejectValue("id_city", "error.code", "Debes seleccionar un municipio");
