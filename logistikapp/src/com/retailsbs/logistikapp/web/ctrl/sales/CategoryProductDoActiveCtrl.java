...
/**
 * Controller para cambiar el estado activo de la categoria de producto
 * @author jorge
 * @since 11-12-2014
 */
public class CategoryProductDoActiveCtrl implements Controller {
	...
	public ModelAndView handleRequest(HttpServletRequest arg0, HttpServletResponse arg1) throws Exception, SupplierNotFoundException {
		...
		Long id_category_product = ServletRequestUtils.getLongParameter(arg0, "id");
		logger.info("id_category_product ="+id_category_product );
		...
		UpdCategoryProductDTO dto = new UpdCategoryProductDTO();
