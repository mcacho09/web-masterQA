...
<body class="fixed-header fixed-leftmenu theme-blue">
								...
								<div class="col-lg-6">
									<div class="main-box">
                                        ...
                                        <header class="main-box-header clearfix">
                                            <h2>Ingresa los datos para la localidad</h2>
                                        </header>
                                        ...
                                        <div class="main-box-body clearfix">
                                            <form id="form" method="post">
							                    ...
							                    <spring:bind path="command.id_city">
	                                                <input type="hidden" id="id_city" name="id_city" value="${city_id}"/>
	                                            </spring:bind>
                                            
                                                <div class="form-group">
                                                    <label for="name">Localidad</label>
								                    <spring:bind path="command.name">
	                                                    <input type="text" class="form-control" id="name" name="name" placeholder="Ingresa nombre de localidad." value="${status.value}">
	                                                </spring:bind>
                                                </div>
								        ...
								        <div class="span4">
								            ...
								            <spring:hasBindErrors name="command">
									            <div class="alert alert-danger">
									                 ${errors.errorCount} error${errors.errorCount==1?'':'es'} al agregar la localidad:
									                 <ul>
	...
	<script>
	function cancelar() {
        location.href = "localitylist.htm?state_id=${state_id}&city_id=${city_id}";
        return true;
	};
	</script>
