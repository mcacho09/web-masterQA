                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="clearfix">
                                    <h1 class="pull-left"><a href="countrylist.htm"><spring:message code="label.admin.country.list.title1"/></a></h1>
                                    
                                    <div class="pull-right">
                                        <button type="button" onclick="location.href='countryadd.htm?accion=add';" class="btn btn-primary btn-xs"><i class="fa fa-plus-circle fa-lg"></i> Nuevo</button>
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="main-box clearfix">
                                        ...
                                        <header class="main-box-header clearfix">
                                            <h2 class="pull-left"><spring:message code="label.admin.country.list.title2"/></h2>
                                        </header>
													...
													<tbody>
														<c:forEach var="cty" items="${list}">
															<tr>
																...
																<td style="width: 20%;">
                                                                    <!-- edit -->
                                                                    <a href="countryupd.htm?id=${cty.id_country}&accion=upd" class="table-link edit">
                                                                        <span class="fa-stack">
