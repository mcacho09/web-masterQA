...
<head>
	...
	<title>Grupos - LogistikApp</title>
						...
						<div class="col-lg-12" style="padding-right:2%;">
							<div class="row">
	                            <div class="col-lg-12">
	                                ...
	                                <div class="clearfix">
	                                    <h1 class="pull-left"><a href="inboxgroup.htm">Grupos de conversaci&oacute;n</a></h1>	                                    
	                                </div>
	                            </div>
                        	</div>
									...
									<div class="col-lg-12">
										<header id="email-header" class="clearfix">
											<div id="email-header-tools" style="margin-left:0; padding-left:2%">
												...
												<div class="btn-group">
													<button onclick="location.href='inboxgroup.htm'" class="btn btn-primary" type="button" title="Actualizar" data-toggle="tooltip" data-placement="bottom">
											...
											<div class="email-content-nano-content" style="margin-left:0; padding-left:2%; width:100%">
												<ul id="email-list">
													...
													<c:forEach var="us" items="${list_users}" varStatus="count">
															<li class="clickable-row" data-href="inboxmsggroup.htm?id_gp=${us.id_group}">
																<div class="chbox">
																	<c:if test="${us.usr_create_grp == useracegi.id_user}">
																		<div class="checkbox-nice">
																			<input type="checkbox" id="m-checkbox-${count.index}" name="inboxchk" value="${us.id_group}"/>
												...
												<form name="formBorrar" id="formBorrar" action="delmsggroup.htm" method="post">
