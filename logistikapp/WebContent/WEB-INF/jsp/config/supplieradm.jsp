...
<head>
	...
	<title>Proveedor - LogistikApp</title>
							...
							<div class="row">
								<div class="col-lg-6">
									<ol class="breadcrumb">
										...
										<li class="active"><a href="supplierlist.htm"><spring:message code="label.breadcrumb.supplier"/></a></li>
									</ol>

									<div class="clearfix">
										<h1 class="pull-left"><spring:message code="${accion == 'add' ? 'label.config.supplier.add.title1' : 'label.config.supplier.upd.title1'}"/></h1>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-6">
									<div class="main-box">
                                        ...
                                        <header class="main-box-header clearfix">
                                            <h2><spring:message code="${accion == 'add' ? 'label.config.supplier.add.title2' : 'label.config.supplier.upd.title2'}"/></h2>
                                        </header>
                                            ...
                                            <form id="form" method="post">
	                                            ...
	                                            <spring:hasBindErrors name="command">
	                                                <div class="form-group">
	                                                    <div class="alert alert-danger">${errors.errorCount} error${errors.errorCount==1?'':'es'} al ${accion == 'add' ? 'agregar' : 'modificar'} el proveedor</div>
	                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <button type="button" class="btn btn-default btn-xs pull-left" onclick="location.href = 'supplierlist.htm';"><i class="fa fa-times fa-lg"/></i> Cancelar</button>
                                                    <button type="submit" class="btn btn-success btn-xs pull-right"><i class="fa fa-check fa-lg"/></i> <spring:message code="${accion == 'add' ? 'label.config.supplier.add.button' : 'label.config.supplier.upd.button'}"/></button>
                                                </div>
