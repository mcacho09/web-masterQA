...
<body class="fixed-header fixed-leftmenu theme-blue">
						...
						<div class="row">
							<div class="col-lg-12">
								...
								<div class="clearfix">
									<h1 class="pull-left">
										<spring:message
											code="label.logistic.travel.upd.title2" />
									</h1>
								</div>
															...
															<div class="row">
																<div
																	...
																	<form method="POST" class="card" name="formadd" id="formadd">
																		...
																		<input type="hidden" id="repetitions" name="repetitions" value="0" /> 
																			...
																			<spring:bind path="command.name">
																				<div
																					...
																					<label for="name">Nombre (requerido)</label> <input
																						...
																						onkeypress=" return nombre_valido(event)"
		...
		<div class="md-content">
			...
			<div class="modal-body">
				<div class="content">
					<div class="row">
						<div class="col-xs-12">
							<button class="btn btn-primary btn-lg" id="oneTime">
								<i class="fa fa-check-square-o"></i> No, sólo programar
							</button>
						</div>
					</div>
					<div class="row hidden" id="divReps">
						<hr />
						<div class="col-lg-12">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success" id="saveTravel">
					<i class="fa fa-clock-o"></i> Sólo Programar
				</button>
			</div>
		</div>
	</div>
	...
	<script>
		...
		function addStoresInTable(isStoresSelected) {
			var ids = []
			...
			RetailServiceBean.getStoresByIdsRoute({ids: ids}, function(data){
				...
				map.refresh()
		  		...
		  		waybills.forEach(function(e, i){
		  			$('.items#' + e.id_store).click()
		  		})
			})
		...
		$('#btnSort').on('click', function() {
			...
			if ($('.dd-item').size() == 0) {
				...
				swal({
					...
					text: 'Esto demorara unos cuantos minutos, ¿Deseá continuar?',
		...
		$(document).on('ready', function() {
			LogisticServiceBean.getTravelById("${ id_travel}", function(data) {
				if (data) {
					//.val(moment(data.schedule.toLocaleDateString()).format('DD/MM/YYYY'))
					$('#schedule').datetimepicker({
						date: data.schedule
					})
				}
			...
			LogisticServiceBean.getIdsRouteByIdTravel("${ id_travel }", function(data) {
				if (data) {
					data.forEach(function(e, i) {
						$('.icheck[value=' + e + ']').iCheck('check')
					})
				}
			})
